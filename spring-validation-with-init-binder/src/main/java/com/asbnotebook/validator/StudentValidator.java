...
public class StudentValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (student.getGrade() <= 0) {
			errors.reject( "student.grade.error",
					"Student grade should be greater than zero");
		}
		/*
		 * if (null != student.getAddress() && Boolean.TRUE.equals(student.getAddress())
		 * && null == student.getAddressDetails()) { errors.rejectValue("address",
		 * messageSource.getMessage("student.address.error", null, Locale.getDefault()),
